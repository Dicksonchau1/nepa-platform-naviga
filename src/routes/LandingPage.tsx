...
const AGENTS = [
  {
    code: 'SODA',
    name: 'Store Operating System',
    desc: 'Autonomous unmanned store intelligence and operations.',
    to: '/products/soda',
    status: 'OPERATIONAL',
  },
  {
    code: 'RODA',
    name: 'Robotic Dispatch',
    desc: 'Physical execution arm for autonomous restocking and fulfillment.',
    to: '/products/roda',
  ...
  },
  {
    ...
    desc: 'Raw frames in, boardroom-ready evidence out.',
    to: '/products/voda-coda',
    status: 'OPERATIONAL',
  },
  {
    code: 'HRI',
    name: 'Behavioral Intelligence API',
    desc: 'NEPA cognition applied to interview and assessment signals.',
    to: '/products/hri',
    status: 'BETA',
  },
  {
    ...
    desc: 'Drone-based facade inspection with audit-grade evidence.',
    to: '/products/foda',
    status: 'BETA',
  },
]
